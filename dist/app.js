...
},{"../render/vnode":27}],13:[function(require,module,exports){
"use strict"
...
},{"../render/render":25}],14:[function(require,module,exports){
"use strict"
...
},{"../promise/promise":18,"../render/vnode":27,"../router/router":31}],15:[function(require,module,exports){
...
},{"./render/fragment":23,"./render/hyperscript":24,"./render/trust":26}],16:[function(require,module,exports){
"use strict"
...
},{"./hyperscript":15,"./mount":17,"./querystring/build":19,"./querystring/parse":20,"./redraw":21,"./render":22,"./request":28,"./route":30,"./util/withAttr":32}],17:[function(require,module,exports){
var redrawService = require("./redraw")

module.exports = require("./api/mount")(redrawService)
},{"./api/mount":12,"./redraw":21}],18:[function(require,module,exports){
(function (global){
"use strict"
/** @constructor */
...
},{"./api/redraw":13}],22:[function(require,module,exports){
module.exports = require("./render/render")(window)
},{"./render/render":25}],23:[function(require,module,exports){
"use strict"
...
},{"../render/vnode":27}],24:[function(require,module,exports){
"use strict"
...
},{"./promise/promise":18,"./request/request":29}],29:[function(require,module,exports){
"use strict"
...
},{"../querystring/build":19}],30:[function(require,module,exports){
var redrawService = require("./redraw")

module.exports = require("./api/router")(window, redrawService)
},{"./api/router":14,"./redraw":21}],31:[function(require,module,exports){
"use strict"
...
},{"../querystring/build":19,"../querystring/parse":20}],32:[function(require,module,exports){
"use strict"
...
},{"./createStore":37,"./utils/warning":39,"_process":1,"lodash/isPlainObject":11}],36:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":11,"symbol-observable":40}],38:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":33,"./bindActionCreators":34,"./combineReducers":35,"./compose":36,"./createStore":37,"./utils/warning":39,"_process":1}],39:[function(require,module,exports){
'use strict';
...
var todoComponent = {};
todoComponent.view = function (vnode) {
...
var todoList = {};
todoList.view = function (vnode) {
  return (0, _mithril2.default)('ul', vnode.attrs.todos.map(function (item) {
    return (0, _mithril2.default)(todoComponent, _extends({
      key: item.id
    }, item, {
      onclick: function onclick() {
        return vnode.attrs.onTodoClick(item.id);
      }
    }));
  }));
};
...
var addTodo = {};
addTodo.view = function (vnode) {
  return (0, _mithril2.default)('.todo-add', [(0, _mithril2.default)('input', {
    value: vnode.state.newTodoName,
    onchange: _mithril2.default.withAttr('value', function (value) {
      vnode.state.newTodoName = value;
    })
...
var todoFooter = {};
todoFooter.view = function (vnode) {
  return (0, _mithril2.default)('p', 'show:', [(0, _mithril2.default)(filterLink, {
    filter: 'SHOW_ALL'
  }, 'All'), (0, _mithril2.default)(filterLink, {
    filter: 'SHOW_ACTIVE'
  }, 'Active'), (0, _mithril2.default)(filterLink, {
    filter: 'SHOW_COMPLETED'
  }, 'Completed')]);
};

var link = {};
link.view = function (vnode) {
  return vnode.attrs.active ? (0, _mithril2.default)('span', vnode.children) : (0, _mithril2.default)('a', {
    href: '#',
...
var filterLink = {};
filterLink.view = function (vnode) {
  var state = store.getState();
  return (0, _mithril2.default)(link, {
...
var visibleTodoList = {};
visibleTodoList.view = function (vnode) {
  var state = store.getState();
  return (0, _mithril2.default)(todoList, {
...
todoAppComponent.view = function (vnode) {
  return (0, _mithril2.default)('.todo-app', [(0, _mithril2.default)(addTodo), (0, _mithril2.default)(visibleTodoList), (0, _mithril2.default)(todoFooter)]);
};

var store = (0, _redux.createStore)(todoApp);
store.subscribe(_mithril2.default.redraw);
_mithril2.default.route(document.getElementById('root'), '/', {
  '/': {
